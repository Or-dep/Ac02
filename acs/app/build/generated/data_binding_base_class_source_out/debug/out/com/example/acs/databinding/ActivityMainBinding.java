...
public final class ActivityMainBinding implements ViewBinding {
  ...
  @NonNull
  public final Button buttonHist;
  ...
  private ActivityMainBinding(@NonNull ConstraintLayout rootView, @NonNull TextView TituloApp,
      @NonNull Button button1, @NonNull Button button2, @NonNull Button buttonHist,
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.buttonHist;
      Button buttonHist = ViewBindings.findChildViewById(rootView, id);
      if (buttonHist == null) {
        break missingId;
      }
      ...
      return new ActivityMainBinding((ConstraintLayout) rootView, TituloApp, button1, button2,
          buttonHist, guideline2, guideline3, guideline4, imageView);
    }
